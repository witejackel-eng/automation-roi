    ...
    <MarketingShell>
      ...
      <main id="main-content" className="w-full">
        ...
        <Section>
          ...
          <div className="mt-8 rounded-md border-2 border-ink/10 bg-white p-6 md:p-8">
            <p className="text-[11px] font-medium uppercase tracking-[0.08em] text-[#C98A1B]">
              The formula
            </p>
            ...
            <p className="mt-4 font-mono tnum text-[15px] leading-[1.6] text-[#111]/50">
        ...
        <Section>
          ...
          <div className="mt-8 rounded-md border border-[#111]/[0.06] bg-white p-6 md:p-8">
            ...
            <p className="mt-3 text-[15px] leading-[1.6] text-[#111]/50">
              ...
              per month ={' '}
              <span className="font-mono tnum text-2xl font-semibold text-[#C98A1B] md:text-3xl">
