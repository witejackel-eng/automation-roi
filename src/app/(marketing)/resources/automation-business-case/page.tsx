      ...
      <main id="main-content" className="w-full">
        ...
        <Section>
          ...
          <ol className="mt-10 grid grid-cols-1 gap-4 md:grid-cols-2">
            {SECTIONS.map((s) => (
              <li key={s.n}>
                <article className="flex h-full flex-col rounded-md border border-black/10 bg-black/[0.02] p-6">
                  <div className="flex items-center gap-3">
                    <span className="flex h-7 w-7 items-center justify-center rounded-full  text-[13px] font-semibold text-[#111]">
                      {s.n}
                    </span>
        ...
        <Section className="bg-black/[0.02]">
          ...
          <ul className="mt-8 grid grid-cols-1 gap-3 sm:grid-cols-2">
            {[
              ...
              <li
                key={d.label}
                className="flex min-h-[44px] items-start gap-3 rounded-md border border-black/10  p-4"
              >
                ...
                <div>
                  ...
                  <p className="mt-1 text-[13px] leading-[1.5] text-black/50">
                    {d.when}
                  </p>
                </div>
              </li>
