...
const STEPS = [
  {
    num: "01",
    title: "Sign Up",
    desc: "Free to start, no credit card",
    file: "Getting Started",
    lang: "bash",
    code: [
      { type: "comment", text: "# Create your free account" },
      { type: "command", text: "Visit viableo.com and sign in with Google" },
      { type: "gap" },
      { type: "output", text: "✓ Account created" },
      { type: "output", text: "✓ Dashboard ready" },
      { type: "output", text: "✓ First case waiting" },
    ],
  },
  {
    num: "02",
    title: "Input Client Data",
    desc: "Fill in the automation opportunity",
    file: "Calculator",
    lang: "typescript",
    code: [
      { type: "comment", text: "// Define the automation opportunity" },
      { type: "keyword", text: "const", after: " opportunity ", keyword2: "=", keyword3: " new ", fn: "Case", args: "({" },
      { type: "prop", key: "  client", val: '"Apex Manufacturing"' },
      { type: "prop", key: "  process", val: '"Invoice Processing"' },
      { type: "prop", key: "  currentFTE", val: "4.5" },
      { type: "prop", key: "  hourlyRate", val: "35" },
      { type: "plain", text: "});" },
    ],
  },
  {
    num: "03",
    title: "Get Results",
    desc: "Instant ROI analysis",
    file: "Results",
    lang: "typescript",
    code: [
      { type: "comment", text: "// AI calculates the business case" },
      { type: "keyword", text: "const", after: " results ", keyword2: "=", keyword3: " await ", fn: "analyze", args: "(opportunity)" },
      { type: "gap" },
      { type: "output", text: "→ Annual savings: $131,860" },
      { type: "output", text: "→ Payback period: 1.6 months" },
      { type: "output", text: "→ 5-year NPV: $542,300" },
    ],
  },
  {
    num: "04",
    title: "Share & Close",
    desc: "Send proposals that win",
    file: "Share",
    lang: "bash",
    code: [
      { type: "comment", text: "# Generate and share the proposal" },
      { type: "command", text: "viableo share --pdf --branding" },
      { type: "gap" },
      { type: "output", text: "  Generating proposal..." },
      { type: "output", text: "  Adding client branding..." },
      { type: "success", text: "✓ Proposal ready" },
      { type: "url", text: "  → viableo.com/r/aX8kP2" },
    ],
  },
]
      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-16">
          ...
          <h2 className="mt-5 text-4xl md:text-5xl font-light tracking-tight leading-[1.05]">
            Built for agencies.<br />Loved by their clients.
          </h2>
        </div>
