...
/**
 * AgenticNavigation — shared marketing header.
 *
 * Structure from agentic template MobileNav pattern adapted to
 * Viableo's dark editorial palette. Fixed top, transparent over hero,
 * solid on scroll.
 */
...
export function AgenticNavigation() {
  ...
  useEffect(() => {
    const raf = requestAnimationFrame(() => setIsMobileMenuOpen(false));
      ...
      >
        ...
        >
          <Link href="/" className="flex items-center gap-2" aria-label="Viableo — home">
            <span
              className="font-display tracking-tight text-ink transition-all duration-500"
