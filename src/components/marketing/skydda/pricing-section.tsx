    ...
    >
      <div className="mx-auto max-w-7xl px-6 md:px-12 lg:px-16">
        ...
        <div className="mb-16 flex flex-col gap-4">
          ...
          <h2 className="text-balance text-4xl font-normal leading-tight tracking-tight text-white md:text-5xl">
        ...
        <div className="flex w-full flex-col gap-10">
          ...
          <div className="flex items-center gap-4">
            ...
            <button
              ...
              className="relative h-6 w-12 cursor-pointer bg-zinc-800 p-1"
            ...
            {plans.map((plan) => (
              <motion.div
                ...
                className={cn(
                  ...
                  plan.popular
                    ? "border border-amber-500/30 bg-zinc-800 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.1)]"
              ...
              >
                ...
                <div className="flex flex-col gap-4">
                  ...
                  <div className="flex items-baseline gap-1">
                    <h3 className="text-4xl font-normal tracking-tighter text-white">
                      {plan.price}
                    </h3>
                ...
                <Link
                  ...
                  className={cn(
                    ...
                    plan.popular
                      ...
                      : "border border-zinc-600 bg-transparent text-white hover:bg-white/5",
                  )}
                >
                  {plan.cta}
                </Link>
