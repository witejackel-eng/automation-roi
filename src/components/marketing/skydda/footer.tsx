...
export function SkyddaFooter() {
  return (
    <footer className="w-full border-t border-zinc-700/30 bg-zinc-900">
      <div className="mx-auto max-w-7xl px-6 md:px-12 lg:px-16">
        ...
        <div className="grid grid-cols-2 gap-10 py-16 md:grid-cols-6">
          ...
          <div className="col-span-2">
            ...
            <p className="mt-3 max-w-[260px] text-xs leading-relaxed text-zinc-500">
              {DATA_HANDLING_LINE}
            </p>
          </div>
          {/* Link columns */}
        ...
        <div className="flex flex-col gap-3 border-t border-zinc-700/30 py-6 text-xs text-zinc-500 md:flex-row md:items-center md:justify-between">
